...
vignette: >
  %\VignetteIndexEntry{Understanding Correlation Analysis}
...
* [Understanding Heatmaps](Understanding-Heatmaps.html) for broader matrix-style clustering views.
* [Understanding PCA](Understanding-PCA.html) for unsupervised multivariate structure.
* [Understanding Boxplots and Violin Plots](Understanding-Boxplots-and-Violin-Plots.html) if you need to inspect the raw distributions behind a strong correlation.
