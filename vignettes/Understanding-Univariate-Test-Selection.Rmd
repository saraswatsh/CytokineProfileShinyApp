---
title: "Understanding Univariate Test Selection"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Understanding Univariate Test Selection}
...
2. In Step 3, choose the branch that matches the design:
   `Univariate Tests (T-test, Wilcoxon)`, `Multi-level Univariate Tests (Anova, Kruskal-Wallis)`, `Two-way ANOVA`, or `ANCOVA`.
...
* [Understanding Multi-Level Univariate Analysis](Understanding-Multi-Level-Univariate-Analysis.html) for the more detailed one-way, two-way, and ANCOVA workflows.
* [Understanding Error-Bar Plots](Understanding-Error-Bar-Plot.html) for a compact visual summary of group comparisons.
* [Understanding Boxplots and Violin Plots](Understanding-Boxplots-and-Violin-Plots.html) if you want to inspect the distributions before committing to a test.
