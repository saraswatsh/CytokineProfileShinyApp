---
title: "Understanding Error-Bar Plots"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Understanding Error-Bar Plots}
...
If you want to see full distribution shape, [Understanding Boxplots and Violin Plots](Understanding-Boxplots-and-Violin-Plots.html) is usually a better companion.
...
* [Understanding Boxplots and Violin Plots](Understanding-Boxplots-and-Violin-Plots.html) for fuller distribution views.
* [Understanding Volcano Plot](Understanding-Volcano-Plot.html) for two-group effect size plus significance screening.
* [Understanding Univariate Test Selection](Understanding-Univariate-Test-Selection.html) for choosing the underlying statistical workflow more deliberately.
