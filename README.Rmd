...
[![Last Commit](https://img.shields.io/github/last-commit/saraswatsh/CytokineProfileShinyApp/devel.svg)](https://github.com/saraswatsh/CytokineProfileShinyApp/commits/devel) 
...
-   Multiple Analysis Functions:
    ...
    -   Choose from several analysis functions, including but not limited to:
...
-   Interactive & Downloadable Outputs: View results directly within the app or download outputs (e.g. PDF).
...
A quick [installation guide](https://shinyinfo.cytokineprofile.org/articles/R-installation.html) is available to use this app locally.
