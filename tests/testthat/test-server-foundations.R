test_that("theme module tracks system and manual theme choices", {
  ...
  shiny::testServer(wrap_server_with_app_ctx(CytokineProfileShinyApp:::mod_theme_server, app_ctx), {
...
test_that("wizard step module initializes the workflow at step 1", {
  ...
  shiny::testServer(wrap_server_with_app_ctx(CytokineProfileShinyApp:::mod_wizard_step_control_server, app_ctx), {
...
test_that("persistent state module seeds the shared app context", {
  ...
  shiny::testServer(wrap_server_with_app_ctx(CytokineProfileShinyApp:::mod_persistent_state_server, app_ctx), {
